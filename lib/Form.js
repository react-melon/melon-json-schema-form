(function (global, factory) {
    ...
    var JSONSchemaForm = function (_Form) {
        ...
        JSONSchemaForm.prototype.render = function render() {
            ...
            var _props2$uiSchema = _props2.uiSchema;
            var uiSchema = _props2$uiSchema === undefined ? {} : _props2$uiSchema;
            var _props2$value = _props2.value;
            var value = _props2$value === undefined ? {} : _props2$value;
            var renderForm = _props2.renderForm;
            var rest = babelHelpers.objectWithoutProperties(_props2, ['schema', 'uiSchema', 'value', 'renderForm']);
