(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon/Button', 'melon/Icon', 'melon-core/util/shallowEqual', '../../Field', '../Control', '../../../factory', '../../../util/field', '../../ValidityLabel', '../../../util/schema', '../../../util/createStateClassName'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon/Button'), require('melon/Icon'), require('melon-core/util/shallowEqual'), require('../../Field'), require('../Control'), require('../../../factory'), require('../../../util/field'), require('../../ValidityLabel'), require('../../../util/schema'), require('../../../util/createStateClassName'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.Button, global.Icon, global.shallowEqual, global.Field, global.Control, global.factory, global.field, global.ValidityLabel, global.schema, global.createStateClassName);
        global.VariableArray = mod.exports;
    }
})(this, function (exports, _react, _Button, _Icon, _shallowEqual, _Field, _Control, _factory, _field, _ValidityLabel, _schema, _createStateClassName) {
    'use strict';
    ...
    var VariableArray = function (_Component2) {
        ...
        VariableArray.prototype.render = function render() {
            ...
            var addButton = !readOnly && maxItems > value.length ? _react2['default'].createElement(
                _Button2['default'],
                {
                    disabled: disabled,
                    type: 'button',
            ...
            var className = (0, _createStateClassName2['default'])('ui-control-variable-array', this.props);
