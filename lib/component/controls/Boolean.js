(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon/Toggle', '../../factory', 'melon-core/util/shallowEqual', '../ValidityLabel', '../../util/createStateClassName'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon/Toggle'), require('../../factory'), require('melon-core/util/shallowEqual'), require('../ValidityLabel'), require('../../util/createStateClassName'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.Toggle, global.factory, global.shallowEqual, global.ValidityLabel, global.createStateClassName);
        global.Boolean = mod.exports;
    }
})(this, function (exports, _react, _Toggle, _factory, _shallowEqual, _ValidityLabel, _createStateClassName) {
    'use strict';
    ...
    var BooleanField = function (_Component) {
        ...
        BooleanField.prototype.render = function render() {
            ...
            var className = (0, _createStateClassName2['default'])('ui-control-boolean', this.props);
