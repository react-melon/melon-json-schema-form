(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon-colorpicker', 'melon-core/util/shallowEqual', '../../../factory', '../../ValidityLabel', '../../../util/createStateClassName'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon-colorpicker'), require('melon-core/util/shallowEqual'), require('../../../factory'), require('../../ValidityLabel'), require('../../../util/createStateClassName'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.melonColorpicker, global.shallowEqual, global.factory, global.ValidityLabel, global.createStateClassName);
        global.Color = mod.exports;
    }
})(this, function (exports, _react, _melonColorpicker, _shallowEqual, _factory, _ValidityLabel, _createStateClassName) {
    'use strict';
    ...
    var ColorControl = function (_Component) {
        ...
        ColorControl.prototype.render = function render() {
            ...
            var className = (0, _createStateClassName2['default'])('ui-control-color', this.props);
