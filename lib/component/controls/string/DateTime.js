(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', 'react', 'melon-calendar', 'melon-timepicker', '../../../factory', 'moment', '../../../util/createStateClassName', '../../ValidityLabel'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('react'), require('melon-calendar'), require('melon-timepicker'), require('../../../factory'), require('moment'), require('../../../util/createStateClassName'), require('../../ValidityLabel'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.react, global.melonCalendar, global.melonTimepicker, global.factory, global.moment, global.createStateClassName, global.ValidityLabel);
        global.DateTime = mod.exports;
    }
})(this, function (exports, _react, _melonCalendar, _melonTimepicker, _factory, _moment, _createStateClassName, _ValidityLabel) {
    'use strict';
    ...
    function DateTimeControl(props) {
        ...
        var className = (0, _createStateClassName2['default'])('ui-control-datetime', props);
