(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './component/controls/Object', './component/controls/Boolean', './component/controls/string/Text', './component/controls/string/Color', './component/controls/string/Date', './component/controls/string/Time', './component/controls/string/DateTime', './component/controls/string/Enum', './component/controls/string/Range', './component/controls/string/Image', './component/controls/array/VariableArray', './component/controls/array/Tuple', './component/controls/array/CheckBox', './component/controls/Control', './Form', './component/Field', './util/schema', './createReducer'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./component/controls/Object'), require('./component/controls/Boolean'), require('./component/controls/string/Text'), require('./component/controls/string/Color'), require('./component/controls/string/Date'), require('./component/controls/string/Time'), require('./component/controls/string/DateTime'), require('./component/controls/string/Enum'), require('./component/controls/string/Range'), require('./component/controls/string/Image'), require('./component/controls/array/VariableArray'), require('./component/controls/array/Tuple'), require('./component/controls/array/CheckBox'), require('./component/controls/Control'), require('./Form'), require('./component/Field'), require('./util/schema'), require('./createReducer'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.Object, global.Boolean, global.Text, global.Color, global.Date, global.Time, global.DateTime, global.Enum, global.Range, global.Image, global.VariableArray, global.Tuple, global.CheckBox, global.Control, global.Form, global.Field, global.schema, global.createReducer);
        global.index = mod.exports;
    }
})(this, function (exports, _Object, _Boolean, _Text, _Color, _Date, _Time, _DateTime, _Enum, _Range, _Image, _VariableArray, _Tuple, _CheckBox, _Control, _Form, _Field, _schema, _createReducer) {
    'use strict';

    exports.__esModule = true;
    exports.fill = exports.Control = exports.CheckBoxControl = exports.TupleControl = exports.VariableArrayControl = exports.ImageControl = exports.EnumControl = exports.DateTimeControl = exports.TimeControl = exports.DateControl = exports.ColorControl = exports.TextControl = exports.RangeControl = exports.BooleanControl = exports.ObjectControl = exports.Field = exports.Form = exports.createReducer = undefined;
