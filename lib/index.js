(function (global, factory) {
    if (typeof define === "function" && define.amd) {
        define(['exports', './factory', './Form', './Field', './Object', './Boolean', './number/Range', './number/Number', './string/Color', './string/Date', './string/EnumText', './string/Image', './string/Text', './array/CheckBox', './array/Tuple', './array/VariableArray', './util/resolveDefaults', './pointer', './babelHelpers'], factory);
    } else if (typeof exports !== "undefined") {
        factory(exports, require('./factory'), require('./Form'), require('./Field'), require('./Object'), require('./Boolean'), require('./number/Range'), require('./number/Number'), require('./string/Color'), require('./string/Date'), require('./string/EnumText'), require('./string/Image'), require('./string/Text'), require('./array/CheckBox'), require('./array/Tuple'), require('./array/VariableArray'), require('./util/resolveDefaults'), require('./pointer'), require('./babelHelpers'));
    } else {
        var mod = {
            exports: {}
        };
        factory(mod.exports, global.factory, global.Form, global.Field, global.Object, global.Boolean, global.Range, global.Number, global.Color, global.Date, global.EnumText, global.Image, global.Text, global.CheckBox, global.Tuple, global.VariableArray, global.resolveDefaults, global.pointer, global.babelHelpers);
        global.index = mod.exports;
    }
})(this, function (exports, _factory, _Form, _Field, _Object, _Boolean, _Range, _Number, _Color, _Date, _EnumText, _Image, _Text, _CheckBox, _Tuple, _VariableArray, _resolveDefaults, _pointer, babelHelpers) {
    'use strict';
